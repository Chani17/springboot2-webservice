package com.chanhee.springboot.controller;
...
public class PostsApiControllerTest {
    ...
    @Autowired
    private TestRestTemplate restTemplate;  // 이거 알아보기
    ...
    public void Posts_수정된다() throws Exception {
        ...
        HttpEntity<PostsUpdateRequestDto> requestEntity = new HttpEntity<>(requestDto);     // http entity에 requestDto를 담아줌
